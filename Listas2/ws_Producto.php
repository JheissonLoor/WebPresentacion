...
$rsProducto = mysqli_query($bean->getConexion(), $sql);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO Producto (producto_id, nombreProducto, precio, categoria_id) VALUES ('$producto_id', '$nombreProducto', '$precio', '$categoria_id')";
...
<div class="container">
    ...
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
        <?php
        // bucle para realizar recorrido sobre $rsProducto
        while ($fila = mysqli_fetch_array($rsProducto)) {
            ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    data-bs-toggle="modal" data-bs-target="#modalProducto">Editar</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="nuevoProductoModalLabel">Producto</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <div class="mb-3">
                        <label for="producto_id" class="form-label">ID</label>
